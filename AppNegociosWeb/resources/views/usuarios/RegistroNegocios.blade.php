        ...
        <div class="col s12 m10  l10 offset-m1 offset-l1 ">
            <div class="card card">
                <div class="card-content hoverable">
                   <div class="cont-padd">
                    <span class="card-title"><b> REGISTRAR NEGOCIO</b></span> </br> </br>
                            ...
                            <div class="row">
                                    <div class="row">
                                        <div class="form-group{{ $errors->has('Nombre_Negocio') ? ' has-error' : '' }}">
                                            <div class="input-field col s12 m6 l6">
                                                ...
                                                <input id="Nombre_Negocio" type="text" maxlength="30" class="form-control" name="Nombre_Negocio" value="{{ old('Nombre_Negocio') }}" required autofocus>
                                        ...
                                        <div class="form-group{{ $errors->has('Direccion_N') ? ' has-error' : '' }}">
                                            <div class="input-field col s12 m6 l6">
                                                ...
                                                <input id="Direccion_N" type="text" maxlength="80" class="form-control" name="Direccion_N" value="{{ old('Direccion_N') }}" required >
                                                    ...
                                                    @endif
                                                <label for="icon_prefix" style="font-size:12px;">Deirección</label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="file-field input-field col s12 m12 l12">
                                            <div class="btn">
                                                <span>Buscar imagenes para su negocio</span>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="input-field col s12">  
                                                ...
                                                <label for="icon_prefix">Palabras clave para relacionar con su negocio. Enter para agregar</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <a class="btn btn-secundario waves-effect waves-light red lighten-2 tooltipped" href="/musuario" data-position="bottom" data-delay="50" data-tooltip="Regresar al menú principal">Cancelar</a>
                                    </div>
                                </div>
                            </div>
                        </form>
...
var token = $('meta[name=csrf-token]').attr('content');
    $(document).ready(function(){
        ...
        $('input.autocomplete').autocomplete({
            data: {
              "Juan Perez Gomez               juan.03@mail.com" : 'https://image.flaticon.com/icons/svg/306/306473.svg',
              "Antonio Cruz Martinez          AntoniCruz086@mail.com" : 'https://image.flaticon.com/icons/svg/306/306473.svg',
              "Maria Hernandez Gonzalez       Mari.76_hrz@mail.com" : 'https://image.flaticon.com/icons/svg/306/306473.svg',
            },
        ...
        var txtFile= document.getElementById('file').value;  
            ...
            //Validacio, fechas de la suscripcion, Campos obligatorios
